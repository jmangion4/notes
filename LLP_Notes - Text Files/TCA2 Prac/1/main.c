...
int main(void)
{
    ...
    print_rect_info(door);
    putchar('\n');
    print_square_info(tile);
    putchar('\n');
    print_circle_info(wheel);
    putchar('\n');
    print_triangle_info(ramp);
    putchar('\n');
    print_cuboid_info(room);
    putchar('\n');
    print_sphere_info(ball);
    putchar('\n');
    print_cylinder_info(pipe);
    putchar('\n');
